...
describe 'Task model function', type: :model do
  context 'Validation test' do
    ...
    it 'Validation passes' do
      task = Task.new(title: 'title', content: 'pass test', deadline: '2021/09/24', status: 'Complete', priority: 'Low').save
  ...
  describe 'Search function' do
    context 'When fuzzy search of title is performed by scope method' do
      it "Tasks containing search keywords are narrowed down" do
        Task.create(title: "title1", content: "content1", deadline: "2021/09/24", status:"Complete", priority: "Low")
