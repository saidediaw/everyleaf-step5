...
RSpec.describe 'Task management function', type: :system do
  before do
    ...
    FactoryBot.create(:task, title: "title2", content: "content2", deadline: "2021/09/24", status:"Complete", priority: "Low", user_id: @user.id)
    FactoryBot.create(:task, title: "title3", content: "content3", deadline: "2021/09/24", status:"Complete", priority: "Low", user_id: @user.id)
  end
